...
//			$html .= "<li><a href='{$this->uri}&page=1'>{$this->config["first"]}</a></li>";
			$html .= "<li><a href='javascript:showpage(\"{$this->uri}&page=1\")'>{$this->config["first"]}</a></li>";
...
//			$html .= "<li><a  href='{$this->uri}&page=" . ($this->page - 1) . "'>{$this->config["prev"]}</a></li>";
			$html .= "<li><a  href='javascript:showpage(\"{$this->uri}&page=" . ($this->page - 1) . "\")'>{$this->config["prev"]}</a></li>";
...
//			$linkPage .= "<li><a href='{$this->uri}&page={$page}'>{$page}</a></li>";
			$linkPage .= "<li><a href='javascript:showpage(\"{$this->uri}&page={$page}\")'>{$page}</a></li>";
...
//			$html .= "<li><a href='{$this->uri}&page=" . ($this->page + 1) . "'>{$this->config["next"]}</a></li>";
			$html .= "<li><a href='javascript:showpage(\"{$this->uri}&page=" . ($this->page + 1) . "\")'>{$this->config["next"]}</a></li>";
...
//			$html .= "<li><a href='{$this->uri}&page=" . ($this->pageNum) . "'>{$this->config["last"]}</a></li>";
			$html .= "<li><a href='javascript:showpage(\"{$this->uri}&page=" . ($this->pageNum) . "\")'>{$this->config["last"]}</a></li>";
