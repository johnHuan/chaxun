        ...
        <div class="container">
            <div class="navbar-header">
                <a href="#" class="navbar-brand logo">
                    <img src="/chaxun/Public/img/logo1.png"  style="padding:-10px;margin:-10px;" alt="东北大学宿舍查询 & 考场查询">
					
                </a>
            </div>
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right menu-drop">
                    <li><a href="/chaxun/index.php/Home/Index" target="_blank"><span class="icon-home glyphicon glyphicon-home">去前台查看</span> </a></li>
                    ...
                    <li><a onclick="if (confirm('确定要退出吗？')) return true; else return false;" href="/chaxun/index.php/Admin/Manager/logout" target="_top"><span class="glyphicon glyphicon-off">退出系统</span></a></li>
                    </ul>
            </div>
